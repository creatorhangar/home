            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                    <div className={`${isPro ? 'bg-gradient-to-br from-primary to-purple-600 text-white' : 'bg-white border-2 border-gray-200'} rounded-2xl p-6 shadow-lg`}>
                        ...
                        const [isAnnual, setIsAnnual] = useState(false); // New state for toggle
                        ...
                        <div className="max-w-7xl mx-auto px-6 py-12">
                            ...
                            <div className="grid md:grid-cols-3 gap-6 mb-12">
                                <div className={`${isPro ? 'bg-gradient-to-br from-primary to-purple-600 text-white' : 'bg-white border-2 border-gray-200'} rounded-2xl p-6 shadow-lg`}>
                                    ...
                                    {isFree && (
                                        <div className="mt-4">
                                            {/* Toggle Switch inside Dashboard Card */}
                                            <div className="flex items-center justify-start gap-3 mb-4 p-1 bg-gray-100/50 rounded-lg w-fit">
                                                <button
                                                    onClick={() => setIsAnnual(false)}
                                                    className={`px-3 py-1 rounded-md text-sm font-medium transition-all ${!isAnnual ? 'bg-white shadow text-primary' : 'text-gray-500 hover:text-gray-900'}`}
                                                >
                                                    Mensal
                                                </button>
                                                <button
                                            ...
                                            <UpgradeButton period={isAnnual ? 'yearly' : 'monthly'} />
                                            <p className="text-xs text-gray-500 mt-2 text-center">
                                                {isAnnual ? 'R$ 239,00 / ano' : 'R$ 29,90 / mês'}
                                            </p>
                                        </div>
                                    )}
